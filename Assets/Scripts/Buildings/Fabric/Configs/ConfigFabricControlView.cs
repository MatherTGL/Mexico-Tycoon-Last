...
namespace Config.FabricControl.View
{
    ...
    {
        [SerializeField, BoxGroup("Colors Parameters"), Title("Buyed"), HideLabel]
        private Color _colorBuyed;
        public Color colorBuyed => _colorBuyed;

        [SerializeField, BoxGroup("Colors Parameters"), Title("Selled"), HideLabel]
        private Color _colorSelled;
        public Color colorSelled => _colorSelled;

        [SerializeField, BoxGroup("Colors Parameters"), Title("Active Work"), HideLabel]
        private Color _colorActiveWork;
        public Color colorActiveWork => _colorActiveWork;

        [SerializeField, BoxGroup("Colors Parameters"), Title("Deactive Work"), HideLabel]
